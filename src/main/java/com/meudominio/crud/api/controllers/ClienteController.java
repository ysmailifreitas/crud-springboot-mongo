package com.meudominio.crud.api.controllers;
...
import com.meudominio.crud.api.responses.Response;
...
public class ClienteController {
	...
	@GetMapping(path="/{id}")
	public ResponseEntity<Response<Cliente>> listarPorId(@PathVariable(name="ud")String id){
